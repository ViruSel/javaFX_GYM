...
public class CtrlManagerToolsManagerFeedback implements Initializable
{
    @FXML
    ...
    private void showFeedback()
    {
        try{
            ...
            ResultSet rs = con.createStatement().executeQuery("Select * FROM feedback WHERE `forWho` = 'Manager'");
